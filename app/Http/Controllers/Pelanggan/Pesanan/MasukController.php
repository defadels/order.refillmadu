...
class MasukController extends Controller
{
  ...
  function __construct()
  {
    //  $this->middleware('permission:pesanan-preorder-lihat', ['only' => ['index','show']]);
      // $this->middleware('permission:pesanan-preorder-tambah', ['only' => ['create','create2','store']]);
      // $this->middleware('permission:pesanan-preorder-edit', ['only' => ['edit','update','destroy']]);
  }
  ...
  public function create()
  {
    ...
    return view(
      'pelanggan.pesanan.masuk.create_1',
      compact(
        'judul',
        'judul_deskripsi',
        'breadcrumbs',
  ...
  public function create2(Request $req)
  {
    ...
    return view(
      'pelanggan.pesanan.masuk.create',
      compact(
        'judul',
        'judul_deskripsi',
        'breadcrumbs',
  ...
  public function store(Request $req)
  {
    ...
    return redirect()->route('pelanggan.pesanan.masuk.index')->with('sukses', 'Tambah Pesanan Sukses');
  }
  ...
  public function update(Request $req, $id)
  {
    ...
    $messages = [
      ...
      'biaya_tambahan.required' => 'Biaya Tambahan harus diperkirakan',
      'biaya_packing.required' => 'Biaya Packing harus diisi',
      'diskon.required' => 'Diskon harus diperkirakan',
      'dibayar.required' => 'Jumlah yang dibayar harus diisi'
    ];
    ...
    return redirect()->route('pelanggan.pesanan.masuk.index')->with('sukses', 'Update Pesanan Sukses');
  }
    ...
    try {
      ...
      if ($req->has('aksi') && ($req->aksi =="masuk" || $req->aksi == "batal")) {
        ...
        return response()->json([
          ...
          'success' => true,
          'redirect' => route('pelanggan.pesanan.masuk.index')
        ]);
      } else {
        return response()->json([
          'judul' => $nama.' Gagal',

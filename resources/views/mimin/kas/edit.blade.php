                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        {!! Form::model($kas,['method'=>'patch','route' => ['mimin.kas.update',$kas->id],'class'=>'form form-horizontal','enctype'=>'multipart/form-data']) !!}
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <li class="d-inline-block mr-2">
                                                                <fieldset>
                                                                    <div class="vs-radio-con">
                                                                        <input type="radio" name="jenis" {{$kas->jenis == 'ditangan'?'checked':''}} value="ditangan">
                                                                        <span class="vs-radio">
                                                            ...
                                                            <li class="d-inline-block mr-2">
                                                                <fieldset>
                                                                    <div class="vs-radio-con">
                                                                        <input type="radio" name="jenis" {{$kas->jenis == 'bank'?'checked':''}} value="bank">

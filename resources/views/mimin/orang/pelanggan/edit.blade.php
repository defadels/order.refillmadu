...
$('.caripelanggan').select2({
  placeholder: 'Cari dan Pilih Leader ...',
    allowClear: true,
    ajax: {
      url: '{{route('mimin.orang.pelanggan.cari')}}',
      dataType: 'json',
      delay: 250,
                    ...
                    <div class="col-md-12 col-12">
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        {!! Form::model($pelanggan, ['method' => 'PUT','route' => ['mimin.orang.pelanggan.update', $pelanggan->id],'class'=>'form form-horizontal']) !!}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
...
<div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            {{  Form::select('status', ['Aktif'=>'Aktif','Tidak Aktif'=>'Tidak Aktif'], old('kategori_id')?old('kategori_id'): $pelanggan->status, ['class' => 'form-control']) }}
                                                             </div>
                                                        </div>
                                                     </div>
                                                    ...
                                                    <div class="col-md-8 offset-md-4">
                                                        ...
                                                        <a href="{{route('mimin.orang.pelanggan.index')}}" class="btn btn-outline-warning mr-1 mb-1">Kembali</a>

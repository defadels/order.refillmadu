                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        {!! Form::model($kurir, ['method' => 'PUT','route' => ['mimin.orang.kurir.update', $kurir->id],'class'=>'form form-horizontal']) !!}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-md-8 offset-md-4">
                                                        ...
                                                        <a href="{{route('mimin.orang.kurir.index')}}" class="btn btn-outline-warning mr-1 mb-1">Kembali</a>

                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                    {!! Form::model($stok_keluar, ['method' => 'patch','route' => ['mimin.inventori.stok-keluar.post', $stok_keluar->id],'class'=>'form form-horizontal']) !!}
                                    ...
                                    <table class="table table-dark mb-2">
                                        ...
                                        <tbody>
                                          ...
                                          @endforeach
                                                  ...
                                                  <p class="mb-0">
                                                      Pastikan terlebih dahulu seluruh data yang diinput sudah sesuai. Setelah diposting, stok keluar produk tidak dapat dihapus dan diubah selamanya.
                                                  </p>
                                                  </div>
                                                   </div>

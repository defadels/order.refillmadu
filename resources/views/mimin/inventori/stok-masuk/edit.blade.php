                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Formulir Stok Masuk</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        {!! Form::model($stok_masuk, ['method' => 'PUT','route' => ['mimin.inventori.stok-masuk.update', $stok_masuk->id],'class'=>'form form-horizontal']) !!}
                                            <div class="form-body">
                                                <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-4 input-group">
                                                                ...
                                                                {{ Form::text('tanggal',old('tanggal')?old('tanggal'):($stok_masuk->tanggal?$stok_masuk->tanggal->format('d-m-Y'):""), ['class' => 'form-control tanggal','required']) }}

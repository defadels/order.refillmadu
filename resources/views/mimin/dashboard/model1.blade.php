...
@include('mimin.dashboard.partial.rupiah_today')

</div>
<div class="col-lg-3 col-md-6 col-12">

@include('mimin.dashboard.partial.kilo_today')
</div>

  <div class="col-lg-3 col-md-6 col-12">

@include('mimin.dashboard.partial.rupiah_thismonth')

</div>
<div class="col-lg-3 col-md-6 col-12">

@include('mimin.dashboard.partial.kilo_thismonth')
</div>
  ...
  <div class="row">
    ...
    <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Omset Setahun Terakhir</h4>
                                </div>
          ...
          <div class="card-body">
            <div class="row pb-50">
              <div class="col-lg-6 col-12 d-flex justify-content-between flex-column order-lg-1 order-2 mt-lg-0 mt-2">
                <div>
                  <h2 class="text-bold-700 mb-25">500kg</h2>
                  <p class="text-bold-500 mb-75">Rata-rata per bulan</p>
                  <h5 class="font-medium-2">
                    <span class="text-success">+20% </span>
                    <span>dibanding bulan lalu</span>
                  </h5>
                </div>
                <a href="#" class="btn btn-primary shadow">Lebih Detil <i class="feather icon-chevrons-right"></i></a>
              </div>
            ...
            <div class="row avg-sessions pt-50">
              ...
              <div class="col-6">
                <p class="mb-0">Distributor: 200 org</p>
              ...
              <div class="col-6">
                <p class="mb-0">Reseller: 3000 org</p>
    ...
    <div class="col-md-6 col-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between pb-0">
          <h4 class="card-title">Penagihan Piutang Bulan Ini</h4>

        </div>
        <div class="card-content">
          <div class="card-body pt-0">
            <div class="row">
              <div class="col-sm-3 col-12 d-flex flex-column flex-wrap text-center">
                <h1 class="font-large-2 text-bold-700 mt-2 mb-0">157.000</h1>
                <small>Ribu Rupiah</small>
              </div>
              <div class="col-sm-9 col-12 d-flex justify-content-center">
                <div id="support-tracker-chart"></div>
              </div>
            </div>
            <div class="chart-info d-flex justify-content-between">
              <div class="text-center">
                <p class="mb-50">Piutang Baru</p>
                <span class="font-large-1">500.000K</span>
              </div>
              <div class="text-center">
                <p class="mb-50">Total Piutang</p>
                <span class="font-large-1">900.000K</span>
              </div>
              <div class="text-center">
                <p class="mb-50">Sudah Diulunasi</p>
                <span class="font-large-1">200.000K</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="row match-height">
          ...
          <div class="card-body">
            ...
            <div class="chart-info d-flex justify-content-between mb-1">
              <div class="series-info d-flex align-items-center">
                ...
                <span class="text-bold-600 ml-50">Masuk</span>
              </div>
            ...
            <div class="chart-info d-flex justify-content-between mb-1">
              <div class="series-info d-flex align-items-center">
                ...
                <span class="text-bold-600 ml-50">Diproses</span>
              </div>
              <div class="product-result">
                <span>14658</span>
              </div>
            ...
            <div class="chart-info d-flex justify-content-between mb-75">
              <div class="series-info d-flex align-items-center">
                ...
                <span class="text-bold-600 ml-50">Selesai</span>
              </div>
              <div class="product-result">
                <span>4758</span>
              </div>
    ...
    <div class="col-lg-4 col-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-start">
          <div>
            <h4 class="card-title">Statistik Piutang</h4>
            <p class="text-muted mt-25 mb-0">6 Bulan Terakhir</p>
          </div>
    ...
    <div class="col-lg-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Top Distributor</h4>
        </div>
        <div class="card-content">
          <div class="card-body">
...
var kiloToday = new ApexCharts(
  document.querySelector("#kilo-today"),
  kiloTodayOptions
);
...
var rupiahToday = new ApexCharts(
  document.querySelector("#rupiah-today"),
  rupiahTodayOptions
);
...
var kiloThismonth = new ApexCharts(
  document.querySelector("#kilo-thismonth"),
  kiloThismonthOptions
);

kiloThismonth.render();
 // kilo today end


 // rupiah today start
var rupiahThismonthOptions = {
  chart: {
    height: 100,
    type: 'area',
    toolbar: {
  ...
  series:  [{!! $rupiah_thismonth['series'] !!}],
...
var rupiahThismonth = new ApexCharts(
  document.querySelector("#rupiah-thismonth"),
  rupiahThismonthOptions
);

rupiahThismonth.render();
 // rupiah today ends
...
$(document).ready(function () {
  ...
  var lineAreaOptions = {
    ...
    series: [{
      name: 'rupiah',
      data: {!! $rupiah_tahunan_rupiah !!}
    }, {
      name: 'kilo',
      data: {!! $rupiah_tahunan_kilo !!}
    }],
    legend: {
      offsetY: -10
    },

...
{!! Form::open(['method'=>'get','route' => ['mimin.laporan.piutang.index'],'class'=>'form form-inline input-group']) !!}
...
{!!Form::close()!!}
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <td colspan="9">Tidak ada piutang {{$start_date->format("d-m-Y")}} hingga {{$end_date->format("d-m-Y")}}</td>
                                        </tr>
                                        @endforelse
                                        </tbody>
                                    </table>

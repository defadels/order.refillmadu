                    ...
                    <div class="row match-height">
                        ...
                        <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        {!! Form::open(['route' => ['mimin.dompet.pelanggan.kurangi',$pelanggan->id],'class'=>'form form-horizontal']) !!}
                                            <div class="form-body">
                                                <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            ...
                                                            {{ Form::text('dibayar_oleh',old('dibayar_oleh'), ['class' => 'form-control', 'placeholder'=>'Yang Mengeluarkan Dana']) }}
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            ...
                                                            {{ Form::text('dibayar_kepada',old('dibayar_kepada'), ['class' => 'form-control', 'placeholder'=>'Yang Menerima Dana']) }}
                                                      </div>
                                                          </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-8 offset-md-4">
                                                        ...
                                                        <a href="{{route('mimin.dompet.pelanggan.index',$pelanggan->id)}}" class="btn btn-outline-warning mr-1 mb-1">Kembali</a>

                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Formulir untuk Menambah Kabupaten</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        {!! Form::open(['route' => ['mimin.pengaturan.provinsi.kabupaten.store',$provinsi->id],'class'=>'form form-horizontal']) !!}
                                            <div class="form-body">
                                                <div class="row">

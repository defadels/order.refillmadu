                                                 ...
                                                 <strong>          {{$pesanan->cabang->nama}} </strong>
                                                  ...
                                                  <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                         <strong>      {{$pesanan->pelanggan->nama}}
                                                           ({{$pesanan->pelanggan->kategori->kode}})
                                                           [{{$pesanan->pelanggan->kategori->nama}}] </strong>
...
@canany(['pesanan.diantar.kirim.simpan','pesanan.diantar.kirim.konfirmasi'])
                                                       <a class="btn btn-success waves-effect waves-light mr-1 mb-1"
                                                       href="{{route('mimin.pesanan.diantar.edit',$pesanan->id)}}"> Kirim </a>
@endcanany
@can('pesanan.diantar.batalkan')
                                                       <a class="btn btn-danger waves-effect waves-light confirm mr-1 mb-1"
                                                       data-namaaksi="membatalkan"
                                                       data-aksi="{{route('mimin.pesanan.diantar.destroy',[$pesanan->id,'aksi'=>'batal'])}}"
                                                       href="javascript:void(0)"> Batalkan Pesanan </a>
@endcan

                                                      <a href="{{route('mimin.pesanan.diantar.index')}}" class="btn btn-outline-warning mr-1 mb-1">Kembali</a>

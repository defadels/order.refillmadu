...
$('.cariproduk').select2({
    ...
    ajax: {
      url: '{{route('mimin.pesanan.masuk.cari-produk')}}',
      dataType: 'json',
      delay: 250,
      data: function (params) {
...
function get_hargax(produk_id,pelanggan_id){
  ...
  if (isNaN(produk_id)){
    ...
    $.ajax({
        url: '{{route('mimin.pesanan.masuk.harga')}}' + '?id_produk=' + produk_id,
...
function hitung(){
  ...
  function get_alamat(alamat_id){
      var hasil =0;
      if (isNaN(alamat_id)){
        return 0;
      }
        $.ajax({
            url: '{{route('mimin.pesanan.masuk.cari-alamat')}}' + '?id=' + alamat_id,
            success: function (data) {
              hasil = data;
            },
            async: false
  ...
  $( "#label_alamat" ).change(function() {
    ...
    console.log(alamat);
    if(alamat.status == 1){
      $('#kepada_nama').val(alamat.results.nama);
      $('#kepada_nomor_hp').val(alamat.results.nomor_hp);
      $('#alamat_tujuan').html(alamat.results.alamat);
...
<section id="basic-horizontal-layouts">
                    ...
                    {!! Form::open(['method' => 'POST','route' => ['mimin.pesanan.masuk.store'],'class'=>'row match-height']) !!}
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                         <strong>      {{$pelanggan->nama}} ( {{$pelanggan->kode}}) [{{$pelanggan->kategori->nama}}]</strong>
                                                 ...
                                                 {!!Form::hidden('pelanggan_id',$pelanggan->id)!!}
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                         <strong>      {{$pelanggan->distributor->nama}}</strong>
                                                 ...
                                                 <div class="col-md-12 offset-md-4">
                                                        <a href="{{route('mimin.pesanan.masuk.create')}}" class="btn btn-outline-warning mr-1 mb-1"><i class="feather icon-edit"></i> Ganti</a>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                {{ Form::select('label',$daftar_label,old('label'), ['class' => 'form-control','id'=>'label_alamat']) }}
                                                             </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-5">
                                                                {{ Form::text('dari_nama',old('dari_nama')?old('dari_nama'):$pelanggan->parent->nama, ['class' => 'form-control','placeholder'=>'nama']) }}
                                                            </div>

                                                            <div class="col-md-4">
                                                                {{ Form::text('dari_nomor_hp',old('dari_nomor_hp')?old('dari_nomor_hp'):$pelanggan->parent->nomor_hp, ['class' => 'form-control','placeholder'=>'nomor hp']) }}
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-5">
                                                                {{ Form::text('kepada_nama',old('kepada_nama')?old('kepada_nama'):$tujuan_nama, ['class' => 'form-control','placeholder'=>'nama','id'=>'kepada_nama']) }}
                                                            </div>
                                                            <div class="col-md-4">
                                                                {{ Form::text('kepada_nomor_hp',old('kepada_nomor_hp')?old('kepada_nomor_hp'):$tujuan_nomor_hp, ['class' => 'form-control','placeholder'=>'nomor hp','id'=>'kepada_nomor_hp']) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                {{ Form::textarea('alamat_tujuan',old('alamat_tujuan')?old('alamat_tujuan'):$tujuan_alamat, ['class' => 'form-control','rows'=>3,'id'=>'alamat_tujuan']) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            {{ Form::text('biaya_tambahan',old('biaya_tambahan')?old('biaya_tambahan'):"0", ['id'=>'biaya_tambahan','class' => 'form-control nominal text-right']) }}
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            {{ Form::text('diskon',old('diskon')?old('diskon'):"0", ['id'=>'diskon','class' => 'form-control nominal text-right']) }}
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            {{ Form::text('biaya_packing',old('biaya_packing')?old('biaya_packing'):"0", ['id'=>'biaya_packing','class' => 'form-control nominal text-right']) }}
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-md-12 offset-md-4">
                                                        ...
                                                        <a href="{{route('mimin.pesanan.masuk.index')}}" class="btn btn-outline-warning mr-1 mb-1">Batal</a>

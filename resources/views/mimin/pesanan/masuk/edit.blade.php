...
$('.caripelanggan').select2({
    ...
    ajax: {
      url: '{{route('mimin.pesanan.masuk.cari-pelanggan')}}',
      dataType: 'json',
      delay: 250,
...
<section id="basic-horizontal-layouts">
                    ...
                    {!! Form::model($pesanan,['method' => 'PATCH','route' => ['mimin.pesanan.masuk.update',$pesanan->id],'class'=>'row match-height']) !!}
                                ...
                                <div class="table-responsive">
                                    <table id="tabel_pesanan" class="table table-striped mb-0">
                                        ...
                                        <tbody>
                                              ...
                                              <tr>
                 <td>
                  {!!Form::select('produk_id[]',[$detil->produk_id=>$daftar_produk[$detil->produk_id]],$detil->produk_id,['class'=>'form-control cariproduk'])!!}

                </td>
                 <td><div class='input-group input-group-md'>
                   {!!Form::number('kuantitas[]',$detil->kuantitas,['class'=>'form-control kuantitas touchspin'])!!}
                  </div>
                 </td>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-5">
                                                                {{ Form::text('dari_nama',$pesanan->dikirim_oleh, ['class' => 'form-control','placeholder'=>'nama']) }}
                                                            </div>

                                                            <div class="col-md-4">
                                                                {{ Form::text('dari_nomor_hp',$pesanan->nomor_hp_pengirim, ['class' => 'form-control','placeholder'=>'nomor hp']) }}
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-5">
                                                                {{ Form::text('kepada_nama',$pesanan->dikirim_kepada, ['class' => 'form-control','placeholder'=>'nama','id'=>'kepada_nama']) }}
                                                            </div>
                                                            <div class="col-md-4">
                                                                {{ Form::text('kepada_nomor_hp',$pesanan->nomor_hp_tujuan, ['class' => 'form-control','placeholder'=>'nomor hp','id'=>'kepada_nomor_hp']) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                {{ Form::textarea('alamat_tujuan',old('alamat_tujuan'), ['class' => 'form-control','rows'=>3,'id'=>'alamat_tujuan']) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            {{ Form::text('diskon',old('diskon'), ['id'=>'diskon','class' => 'form-control nominal text-right']) }}
                                                            </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            {{ Form::text('biaya_packing',old('biaya_packing'), ['id'=>'biaya_packing','class' => 'form-control nominal text-right']) }}
                                                            </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            {{ Form::text('dibayar',old('dibayar')?old('dibayar'):$pesanan->nominal_yang_dibayar, ['id'=>'dibayar','class' => 'form-control nominal text-right']) }}
                                                            </div>
                                                        </div>
                                                </div>

                                                <div class="col-md-12 offset-md-4">
                                                        <button type="submit" class="btn btn-danger mr-1 mb-1">Simpan</button>

                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-12">
                                                  @can('pesanan.masuk.proses')
                                                       <a class="btn btn-success waves-effect waves-light confirm mr-1 mb-1"
                                                       data-namaaksi="memproses"
                                                       data-aksi="{{route('mimin.pesanan.masuk.destroy',[$pesanan->id,'aksi'=>'proses'])}}"
                                                       href="javascript:void(0)"> Proses </a>
                                                  @endcan
                                                  @can('pesanan.masuk.batalkan')
                                                       <a class="btn btn-danger waves-effect waves-light confirm mr-1 mb-1"
                                                       data-namaaksi="membatalkan"
                                                       data-aksi="{{route('mimin.pesanan.masuk.destroy',[$pesanan->id,'aksi'=>'batal'])}}"
                                                       href="javascript:void(0)"> Batalkan </a>
                                                  @endcan
                                                  @can('pesanan.masuk.tunda')
                                                       <a class="btn btn-primary waves-effect waves-light confirm mr-1 mb-1"
                                                       data-namaaksi="menunda"
                                                       data-aksi="{{route('mimin.pesanan.masuk.destroy',[$pesanan->id,'aksi'=>'tunda'])}}"
                                                       href="javascript:void(0)"> Tunda </a>
                                                  @endcan
                                                      <a href="{{route('mimin.pesanan.masuk.index')}}" class="btn btn-outline-warning mr-1 mb-1">Kembali</a>

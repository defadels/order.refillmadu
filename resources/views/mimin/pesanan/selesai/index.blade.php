                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        @forelse ($daftar_pesanan as $pesanan)
                                            ...
                                            <a class="btn btn-icon btn-outline-success btn-sm waves-effect waves-light" href="{{ route('mimin.pesanan.selesai.cetak',$pesanan->id) }}"><i class="feather icon-printer"></i></a>

                                            <a class="btn btn-icon btn-outline-danger btn-sm waves-effect waves-light" href="{{ route('mimin.pesanan.selesai.show',$pesanan->id) }}"><i class="feather icon-eye"></i></a>

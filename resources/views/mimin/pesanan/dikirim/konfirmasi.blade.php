...
<section id="basic-horizontal-layouts">
                    <div class="row match-height">
                                                ...
                                                <div class="col-12">
                                                 ...
                                                 <strong>          {{$pesanan->cabang->nama}} </strong>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-4">
                                                                <span>Resi Diinput oleh</span>
                                                            </div>
                                                            <div class="col-md-8">
                                                              <strong>{{$pesanan->pengiriman_diinput_oleh->nama}}</strong>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            {!! Form::model($pesanan,['method' => 'PATCH','route' => ['mimin.pesanan.dikirim.update',$pesanan->id],'class'=>'form form-horizontal']) !!}
                                    <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 offset-md-4">
                                                        ...
                                                        <a href="{{route('mimin.pesanan.dikirim.index')}}" class="btn btn-outline-warning mr-1 mb-1">Batal</a>

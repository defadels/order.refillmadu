                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-12">
                                                    @can('pesanan.preorder.masukkan')
                                                          <a class="btn btn-success waves-effect waves-light confirm mr-1 mb-1"
                                                          data-namaaksi="mamasukkan"
                                                          data-aksi="{{route('mimin.pesanan.preorder.destroy',[$pesanan->id,'aksi'=>'masuk'])}}"
                                                          href="javascript:void(0)"> Masukkan </a>
                                                    @endcan
                                                    @can('pesanan.preorder.batalkan')
                                                          <a class="btn btn-danger waves-effect waves-light confirm mr-1 mb-1"
                                                          data-namaaksi="membatalkan"
                                                          data-aksi="{{route('mimin.pesanan.preorder.destroy',[$pesanan->id,'aksi'=>'batal'])}}"
                                                          href="javascript:void(0)"> Batalkan </a>
                                                    @endcan

                                                          <a href="{{route('mimin.pesanan.preorder.index')}}" class="btn btn-outline-warning mr-1 mb-1">Kembali</a>
                                                          </div>
                                                </div>
                                            </div>
                                    </div>

...
function hitung(){
  ...
  function get_alamat(alamat_id){
      ...
      if (isNaN(alamat_id)){
        ...
        $.ajax({
            url: '{{route('mimin.pesanan.preorder.cari-alamat')}}' + '?id=' + alamat_id,
            success: function (data) {
              hasil = data;
            },
            async: false
...
<section id="basic-horizontal-layouts">
                    ...
                    {!! Form::model($pesanan,['method' => 'PATCH','route' => ['mimin.pesanan.preorder.update',$pesanan->id],'class'=>'row match-height']) !!}

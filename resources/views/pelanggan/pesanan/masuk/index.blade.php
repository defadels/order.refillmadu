                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        @foreach ($daftar_pesanan as $pesanan)
                                            ...
                                            <a class="btn btn-icon btn-outline-warning btn-sm waves-effect waves-light" href="{{ route('pelanggan.pesanan.masuk.edit',$pesanan->id) }}"><i class="feather icon-edit"></i></a>
                                            <a class="btn btn-icon btn-outline-danger btn-sm waves-effect waves-light" href="{{ route('pelanggan.pesanan.masuk.show',$pesanan->id) }}"><i class="feather icon-check"></i></a>

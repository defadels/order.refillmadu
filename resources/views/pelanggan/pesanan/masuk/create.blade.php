...
$('.caripelanggan').select2({
    ...
    ajax: {
      url: '{{route('pelanggan.pesanan.masuk.cari-pelanggan')}}',
      dataType: 'json',
      delay: 250,
...
function hitung(){
  ...
  function get_alamat(alamat_id){
      ...
      if (isNaN(alamat_id)){
        ...
        $.ajax({
            url: '{{route('pelanggan.pesanan.masuk.cari-alamat')}}' + '?id=' + alamat_id,
            success: function (data) {
              hasil = data;
            },
            async: false
...
<section id="basic-horizontal-layouts">
                    ...
                    {!! Form::open(['method' => 'POST','route' => ['pelanggan.pesanan.masuk.store'],'class'=>'row match-height']) !!}
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-12">
                                                 ...
                                                 <div class="col-md-12 offset-md-4">
                                                        <a href="{{route('pelanggan.pesanan.masuk.create')}}" class="btn btn-outline-warning mr-1 mb-1"><i class="feather icon-edit"></i> Ganti</a>

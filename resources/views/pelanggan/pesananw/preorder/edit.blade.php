...
$('.cariproduk').select2({
    ...
    ajax: {
      url: '{{route('pelanggan.pesanan.preorder.cari-produk')}}',
      dataType: 'json',
      delay: 250,
      data: function (params) {
...
function get_hargax(produk_id,pelanggan_id){
  ...
  if (isNaN(produk_id)){
    ...
    $.ajax({
        url: '{{route('pelanggan.pesanan.preorder.harga')}}' + '?id_produk=' + produk_id,
...
function hitung(){
  ...
  var grand_total =  parseInt(ongkir) +  parseInt(total_belanja);
...
<section id="basic-horizontal-layouts">
                    ...
                    {!! Form::model($pesanan,['method' => 'PATCH','route' => ['pelanggan.pesanan.preorder.update',$pesanan->id],'class'=>'row match-height']) !!}
                                                 ...
                                                 {!!Form::hidden('pelanggan_id',$pelanggan->id)!!}
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                              @if($pesanan->dibayar_oleh == "reseller")
                                                              <strong>Saya</strong>
                                                              @else
                                                              <strong>Pelanggan Saya</strong>
                                                              @endif


                                                            {!!Form::hidden('dibayar_oleh',$pesanan->dibayar_oleh)!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-5">
                                                                {{ Form::text('dari_nama',old('dari_nama')?old('dari_nama'):$pesanan->dikirim_oleh, ['class' => 'form-control','placeholder'=>'nama']) }}
                                                            </div>
                                                            <div class="col-md-4">
                                                                {{ Form::text('dari_nomor_hp',old('dari_nomor_hp')?old('dari_nomor_hp'):$pesanan->nomor_hp_pengirim, ['class' => 'form-control','placeholder'=>'nomor hp']) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-5">
                                                                {{ Form::text('kepada_nama',old('kepada_nama')?old('kepada_nama'):$pesanan->dikirim_kepada, ['class' => 'form-control','placeholder'=>'nama']) }}
                                                            </div>
                                                            <div class="col-md-4">
                                                                {{ Form::text('kepada_nomor_hp',old('kepada_nomor_hp')?old('kepada_nomor_hp'):$pesanan->nomor_hp_tujuan, ['class' => 'form-control','placeholder'=>'nomor hp']) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            @if($pesanan->dibayar_oleh == "reseller")
                                                                ...
                                                                <span>Dibayar</span>
                                                              @else
                                                                <span>Yang Harus Dibayar Pelanggan</span>
                                                              @endif
                                                            </div>
                                                            <div class="col-md-8">

                                    ...
                                    <div class="card-body">
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-12">
                                                       ...
                                                       href="{{route('pelanggan.pesanan.dikirim.edit',$pesanan->id)}}"> Selesaikan </a>
                                                       <a class="btn btn-danger waves-effect waves-light confirm mr-1 mb-1"
                                                       data-namaaksi="membatalkan"
                                                       data-aksi="{{route('pelanggan.pesanan.dikirim.destroy',[$pesanan->id,'aksi'=>'batal'])}}"
                                                       href="javascript:void(0)"> Batalkan </a>

                                                      <a href="{{route('pelanggan.pesanan.dikirim.index')}}" class="btn btn-outline-warning mr-1 mb-1">Kembali</a>

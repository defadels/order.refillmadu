                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        @foreach ($daftar_pesanan as $pesanan)
                                            ...
                                            <a class="btn btn-icon btn-outline-danger btn-sm waves-effect waves-light" href="{{ route('pelanggan.pesanan.diproses.show',$pesanan->id) }}"><i class="feather icon-mail"></i></a>

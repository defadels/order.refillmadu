...
<section id="basic-horizontal-layouts">
                    <div class="row match-height">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                              <strong>{{$pesanan->diproses_pada->format('d F Y')}}</strong>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            {!! Form::model($pesanan,['method' => 'PATCH','route' => ['pelanggan.pesanan.diproses.update',$pesanan->id],'class'=>'form form-horizontal']) !!}
                                    <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                            {{ Form::select('gudang_id',$daftar_gudang,old('gudang_id'), ['class' => 'form-control select2']) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8 input-group">
                                                                ...
                                                                {{ Form::text('tanggal_pengiriman',old('tanggal_pengiriman'), ['class' => 'form-control tanggal','required']) }}
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                {{ Form::select('dikirim_oleh_id',$daftar_kurir,old('dikirim_oleh_id'), ['class' => 'form-control select2']) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 offset-md-4">
                                                        <button type="submit" class="btn btn-primary mr-1 mb-1">Konfirmasi Pengiriman</button>
                                                        <a href="{{route('pelanggan.pesanan.diproses.index')}}" class="btn btn-outline-warning mr-1 mb-1">Batal</a>
